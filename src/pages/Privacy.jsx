function Privacy() {
  return (
    <div 
      ...
      style={{
        backgroundImage: 'url(https://www.shutterstock.com/image-photo/illuminated-container-ship-southampton-docks-600nw-2484604663.jpg)',
    ...
    >
      ...
      <div className="relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-white font-extrabold max-w-2xl mx-auto text-base">
